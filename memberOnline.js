layui.use(['form', 'layer', 'laydate', 'table', 'laytpl'], function() {
    ...
    var tableIns = table.render({
        ...
        limit: 20,
        limits: [10, 15, 20, 25],
        id: "memberOnlineTable",
        cols: [
            [
                { field: 'memberOnlineType', width: 120, title: '类型', align: "center" },
                { field: 'memberOnlineName', width: 120, title: '名称', align: "center" },
                { field: 'memberOnlineAccount', width: 120, title: '账号', align: 'center' },
