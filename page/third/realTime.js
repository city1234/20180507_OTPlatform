    ...
    var tableIns = table.render({
        ...
        cols: [
            [
                ...
                { field: 'realTimeName', title: '会员', width: 200, align: "center" },
                { field: 'realTimeBet', title: '注单号', width: 220, align: 'center' },
                { field: 'realTimeBetTime', title: '下注时间', minWidth: 300, align: "center" },
                { field: 'realTimeBullet', title: '子弹', width: 100, align: "center" },
                { field: 'realTimeBulletPrice', title: '子弹价格', width: 250, align: 'center' },
                { field: 'realTimeFishPrice', title: '鱼价', width: 150, align: "center" },
                { field: 'realTimeProfit', title: '损益', width: 250, align: "center", templet: '#realTimeProfit' },
                { field: 'realTimeJackpot', title: 'jackpot交收', width: 250, align: "center" }
            ]
        ]
    });
