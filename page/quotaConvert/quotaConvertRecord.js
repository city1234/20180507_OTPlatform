    ...
    var tableIns = table.render({
        ...
        cols: [
            [
                ...
                { field: 'CR-status', title: '状态', width: 140, align: 'center', templet:function(d){
                ...
                { title: '操作', align: 'center', width: 100,templet: function(d) {
                    return '<a class="layui-btn layui-btn-border-normal layui-btn-xs" lay-event="operator">操作记录</a>'
                }}
            ]
        ]
    });
